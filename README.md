...
| Method | When to use | Version source |
| --- | --- | --- |
| Manual publish | Pre-release or explicit version publish | `release_version` entered in GitHub Actions |
| Tag-based publish | Normal tagged release | Git tag name |
